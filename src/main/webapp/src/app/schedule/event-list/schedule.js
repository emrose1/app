    ...
    $stateProvider
      .state('schedule', {
        url: '/schedule',
          views: {
            'accounts': {
              templateUrl: 'app/user-account/account-dropdown.tpl.html',
              controller: 'AccountCtrl'
            },
            'calendars': {
              templateUrl: 'app/schedule/calendar/calendar-dropdown.tpl.html',
              controller: 'calendarCtrl'
            },
            'content': {
              controller: 'scheduleCtrl',
              templateUrl: 'app/schedule/event-list/schedule.tpl.html'
            }
          }
      });
    }
